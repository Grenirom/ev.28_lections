...
def get_articles(catalog):
    articles = catalog.find_all('div', class_='Tag--article')[0:20]  # указываем кол-во новостей которое нам нужно
    return articles
...
# get_detail('https://kaktus.media/doc/479619_v_kyrgyzstane_proydet_massovyy_detskiy_zabeg._kak_priniat_ychastie.html')
...
def parse_news(): #чтобы запустить код и проверить что-либо, нужно создать функцию, и в ней указать все прошлые
